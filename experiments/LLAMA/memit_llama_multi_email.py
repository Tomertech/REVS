...
from utils.experiment_old import memit_llama_multi_email_exp
...
if __name__ == "__main__":
    ...
    parser.add_argument('--v_num_grad_steps', type=int, default=1, help='Number of gradient steps for V')
    ...
    parser.add_argument('--layers', type=int, nargs='*', default=[3,4,5,6,7,8], help='Layers to apply MEMIT on')
    ...
    memit_llama_multi_email_exp(config, args.seeds, args.score_thresholds, args.v_lrs, args.loss_breaks, args.loss_pred_prob_coefs, message=args.message)