import argparse
from utils.experiment_old import revs_multi_ssn_exp
...
if __name__ == "__main__":
    ...
    revs_multi_ssn_exp(config, seeds=args.seeds, n_neurons_list=args.n_neurons_list, score_thresholds=args.score_thresholds)
